...
function Home() {
    ...
    const getbestsellproduct = products.slice(0, 4);
    const getflashsaleproduct = products.slice(4, 8);
    const getourproduct = products.slice(8, 22);

    console.log('product', products.slice(5, 8));
    console.log('bestproduct', getbestsellproduct);
    ...
    return (
        <div>
            ...
            <OurProduct OurProduct={getourproduct} />
